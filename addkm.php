...
if(!($stmt = $mysqli->prepare("INSERT INTO gz_kaiju_in_movies (kid, movid) VALUES (?,?)"))){
	echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}
if(!($stmt->bind_param("ii",$_POST['kselect'],$_POST['mselect']))){
...
if(!$stmt->execute()){
	...
	echo "added " . $stmt->affected_rows . " rows to gz_kaiju_in_movies.";
