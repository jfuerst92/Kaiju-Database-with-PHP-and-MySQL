...
if(!($stmt = $mysqli->prepare("INSERT INTO gz_kaiju_powers (kid, pid) VALUES (?,?)"))){
	echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}
if(!($stmt->bind_param("ii",$_POST['kpselect'],$_POST['pselect']))){
...
if(!$stmt->execute()){
	...
	echo "added " . $stmt->affected_rows . " rows to gz_kaiju_powers.";
